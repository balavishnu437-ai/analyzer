...
if st.session_state.page == "home":
    ...
    st.write("**Name:** C NEHA REDDY")
    st.write("**Register No:** RA2511026050001")
...
# -------------------------------
    ...
    smiles = st.text_input(
        "Enter SMILES",
       'CC1=C(C(=O)NC(=O)[C@@H]2[C@H](O)[C@@H](O)[C@H](O)[C@H](O2)CO)C(=O)C3=C(C1=O)C4=C(C=C3O)C(=O)C5=C(C4=O)C=CC(=C5O)OC6=C(C=CC(=C6O)OC)OC.C1[C@@H]([C@H]([C@@H]([C@H](O1)CO)O)O)O.C1[C@@H]([C@H]([C@@H]([C@H](O1)CO)O)O)OOC"
    )
    ...
    if st.button("Analyze"):
        ...
        st.subheader("💊 Drug Name: Vancomycin")

        st.markdown("### 🧬 Molecular Structure")
        st.image(
            "https://pubchem.ncbi.nlm.nih.gov/image/imgsrv.fcgi?cid=14969&t=l",
            caption="Vancomycin Chemical Structure",
