...
# -------------------------------
    ...
    smiles = st.text_input(
        "Enter SMILES",
      """CC1=C(C(=O)NC(=O)[C@@H]2[C@H](O)[C@@H](O)[C@H](O)[C@H](O2)CO)C(=O)C3=C(C1=O)C4=C(C=C3O)C(=O)C5=C(C4=O)C=CC(=C5O)OC6=C(C=CC(=C6O)OC)OC.C1[C@@H]([C@H]([C@@H]([C@H](O1)CO)O)O)O.C1[C@@H]([C@H]([C@@H]([C@H](O1)CO)O)O)O"""
